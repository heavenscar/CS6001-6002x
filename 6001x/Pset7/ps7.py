...
class NewsStory(object):
    def __init__(self, guid, rssTitle, rssSubject, rssSummary, rssLink):
        self.guid = guid
        self.rssTitle = rssTitle
        self.rssSubject = rssSubject
    ...
    def getTitle(self):
        return self.rssTitle
       
    def getSubject(self):
        return self.rssSubject
       
    def getSummary(self):
        return self.rssSummary
...
class WordTrigger(Trigger):
    ...
    def isWordIn(self, text):
        ...
        return (self.word in sentence.split(' '))
...
class AndTrigger(Trigger):
    def __init__(self, trigger1, trigger2):
        self.trigger_a = trigger1
        self.trigger_b = trigger2
